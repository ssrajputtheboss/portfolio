import { Box, Flex, Text, Icon, Menu, MenuButton, MenuList } from '@chakra-ui/react';
...
export default function TerminalTitle({ onClose }: { onClose: Function }): React.ReactElement {
  return (
    <Box bgColor='grey' borderTopRadius='3xl'>
      <Flex flexDir='row' justifyContent='space-between' alignItems='center' w='full'>
        ...
        <Flex flexDir='row' alignItems='center' mr='5'>
          <Menu>
            ...
            <MenuList>
              <Text fontWeight='bold' textColor='blue'>
                Commands are:-
              </Text>
              <Text fontStyle='oblique' pl='2'>
                sort -a | -d
              </Text>
              <Text fontStyle='oblique' pl='2'>
                search keyword
